...
# I will need to import the pygame library first so I can use sound effects in this game
import pygame
...
def lose(nice, mean, name):
    # Sustitute the {} wildcards with our variable values
