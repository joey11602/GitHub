...
//this function changes the slide when the thumbnails are clicked
...
function showSlides(n) {
    ...
    if (n < 1) {slideIndex = slides.length}; //if n is less than 1, te slideIndex is set to the length of the array "slides"
